...
public struct DelegatedAuthenticationComponentStyle {
    ...
    public var headerTextStyle = TextStyle(font: .systemFont(ofSize: 24, weight: .bold),
    ...
    public var amountTextStyle = TextStyle(font: .systemFont(ofSize: 32),
                                           color: UIColor.Adyen.componentLabel,
                                           textAlignment: .center)
    ...
    public var cardNumberTextStyle = TextStyle(font: .systemFont(ofSize: 24, weight: .bold),
                                               color: UIColor.Adyen.componentLabel,
                                               textAlignment: .center)
