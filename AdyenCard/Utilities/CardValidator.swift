...
final class CardValidator {
    ...
    static func validate(cardNumber: String, acceptedCardTypes: [CardType] = CardType.all) -> (isValid: Bool, type: CardType?, formattedNumber: String) { // swiftlint:disable:this large_tuple
    ...
    static func validate(expiryDate: String, separator: String? = "/") -> (isValid: Bool, formattedDate: String) { // swiftlint:disable:this cyclomatic_complexity function_body_length
    ...
    static func validate(cvc: String) -> (isValid: Bool, formattedCvc: String) {
