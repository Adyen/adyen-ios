...
internal extension ThreeDS2Component {
    struct Fingerprint: Encodable { // swiftlint:disable:this explicit_acl
        ...
        internal init(authenticationRequestParameters: ADYAuthenticationRequestParameters) throws {
            ...
            deviceInformation = authenticationRequestParameters.deviceInformation
            self.sdkEphemeralPublicKey = sdkEphemeralPublicKey
            sdkReferenceNumber = authenticationRequestParameters.sdkReferenceNumber
            sdkApplicationIdentifier = authenticationRequestParameters.sdkApplicationIdentifier
            sdkTransactionIdentifier = authenticationRequestParameters.sdkTransactionIdentifier
        }
