...
public enum BillingAddressMode {
    ...
    ///
    /// - Parameter hideForCardBrands: Card types for which the postal code field should be hidden
    ...
    ///   - hideForCardBrands: Card types for which the address form should be hidden
    ///     when detected via BIN lookup.
    case full(
    ...
    ///   - hideForCardBrands: Card types for which the address lookup should be hidden
    ///     when detected via BIN lookup.
    case lookup(
