...
public final class CardComponent: PaymentComponent, PresentableComponent, Localizable, Observer {
                ...
                style: FormComponentStyle = FormComponentStyle())
    {
        ...
        privateSupportedCardTypes = paymentMethod.brands.compactMap(CardType.init)
        self.style = style
        self.clientKey = clientKey
        cardTypeProvider = CardTypeProvider(cardPublicKeyProvider: cardPublicKeyProvider)
    ...
    private func didReceived(bin: String) {
        ...
        cardComponentDelegate?.didChangeBIN(String(bin.prefix(CardComponent.publicBinLenght)), component: self)
    ...
    private func requestCardTypes(for bin: String) {
        cardTypeProvider.requestCardTypes(for: bin, supported: supportedCardTypes) { [weak self] cardTypes in
