...
internal class PreselectedPaymentMethodViewModel: PreselectedPaymentMethodViewModelProtocol {
    ...
    // TODO: Robert: DropInComponent needs to send an event on the component being loaded. We need to set this callback correctly and call it at the right time.
    ...
    internal var subtitleText: String {
        let displayInformation = component.paymentMethod.displayInformation(using: localizationParameters)
        return localizedString(.preselectedPaymentMethodSubtitle, localizationParameters, component.paymentMethod.name, formattedAmount)
    }
