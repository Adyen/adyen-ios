...
extension PayByBankUSComponent {
    ...
    public struct Style {
        ...
        public var subtitle: TextStyle = {
            let subtitleSize: CGFloat = 14 // UIFont.preferredFont(forTextStyle: .callout).pointSize
            return TextStyle(
        ...
        public var message: TextStyle = {
            let messageSize: CGFloat = 14 // UIFont.preferredFont(forTextStyle: .callout).pointSize
            return TextStyle(
