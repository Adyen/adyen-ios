...
internal enum ConfigurationConstants {
    ...
    static let demoServerAPIKey = "AQEthmfxKo7MbhFLw0m/n3Q5qf3VfI5eGbBFVXVXyGHNhisxSHQZLQhnJZKhUXeVEMFdWw2+5HzctViMSCJMYAc=-oIzzffq7wjRWqcRFe1bsItPks2i1MSog34dGaknhoUE=-VzDtyMSa2eBX72_k"
...
internal struct DemoAppSettings: Codable {
    ...
    internal var dropInConfiguration: DropInComponent.Configuration {
        ...
        if dropInSettings.twintEnabled {
            dropInConfig.actionComponent.twint = .init(redirectURL: URL(string: ConfigurationConstants.returnUrl)!)
        }
