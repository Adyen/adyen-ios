...
internal final class DefaultAPIClient: AnyRetryAPIClient {
    ...
    internal func perform<R>(_ request: R, shouldRetry _: ((Result<R.ResponseType, Error>) -> Bool)?, completionHandler: @escaping (Result<R.ResponseType, Error>) -> Void) where R: Request {
