...
The [Drop-in](https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/dropincomponent) handles the presentation of available payment methods and the subsequent entry of a customer's payment details. It is initialized with the response of [`/sessions`][apiExplorer.sessions], and handles the entire checkout flow under the hood.
...
Use **Environment.test** for environment. When you're ready to accept live payments, change the value to one of our [live environments](https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/environment)
...
[reference]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/
[reference.dropInComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/dropin
[reference.installation]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/installation
[reference.styles]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/customization
[reference.advancedFlow]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/threeapis
[reference.cardComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/cardcomponent
[reference.threeDS2Component]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/threeds2component
[reference.applePayComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/applepaycomponent
[reference.bcmcComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/bcmccomponent
[reference.issuerListComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/issuerlistcomponent
[reference.weChatPaySDKActionComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/wechatpaysdkactioncomponent
[reference.qiwiWalletComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/qiwiwalletcomponent
[reference.sepaDirectDebitComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/sepadirectdebitcomponent
[reference.redirectComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/redirectcomponent
[reference.mbWayComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/mbwaycomponent
[reference.BLIKComponent]: https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/blikcomponent
[reference.DokuComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/dokucomponent
[reference.BoletoComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/boletocomponent
[reference.ACHDirectDebitComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/achdirectdebitcomponent
[reference.AffirmComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/affirmcomponent
[reference.BACSDirectDebitComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/bacsdirectdebitcomponent
[reference.OnlineBankingComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/onlinebankingcomponent
[reference.AtomeComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/atomecomponent
[reference.UPIComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/upicomponent
[reference.QRCodeActionComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/qrcodeactioncomponent
[reference.CashAppPayComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/cashapppaycomponent
[reference.TwintComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/twintcomponent
[reference.PayToComponent]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/paytocomponent
[reference.localization]:  https://adyen.github.io/adyen-ios/6.0.0-alpha.test.2/documentation/adyen/localization
