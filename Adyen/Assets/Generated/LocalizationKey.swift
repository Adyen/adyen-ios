...
public struct LocalizationKey {
    ...
    /// You can select the card brand you prefer to pay with. This is optional.
    ...
    /// Copy code
    public static let voucherCodeCopyLabel = LocalizationKey(key: "adyen.voucher.code.copy.label")
    /// Code copied to clipboard
    public static let voucherCodeCopiedLabel = LocalizationKey(key: "adyen.voucher.code.copied.label")
    /// 123.123.123-12
