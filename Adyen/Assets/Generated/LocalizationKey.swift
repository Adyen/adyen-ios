...
public struct LocalizationKey {
    ...
    /// Options
    public static let upiIntentAppsTitle = LocalizationKey(key: "adyen.upi.intent.apps.title")
    /// On your device
    public static let upiIntentAppsTitleOnDevice = LocalizationKey(key: "adyen.upi.intent.apps.title.onDevice")
    /// Cash App Pay
