...
class SEPADirectDebitComponentTests: XCTestCase {
    ...
    func testRequiresKeyboardInput() {
        ...
        let sut = SEPADirectDebitComponent(paymentMethod: method, adyenContext: adyenContext)
    ...
    func testBigTitle() {
        let sepaPaymentMethod = SEPADirectDebitPaymentMethod(type: .sepaDirectDebit, name: "Test name")
        let sut = SEPADirectDebitComponent(paymentMethod: sepaPaymentMethod, adyenContext: adyenContext)
