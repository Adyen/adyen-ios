...
class CardComponentTests: XCTestCase {
    ...
    func testClientKeyInitializatpion() {
        ...
        let sut = CardComponent(paymentMethod: method, clientKey: dummyClientKey)

        XCTAssertEqual(sut.cardBrandProvider.clientKey, dummyClientKey)
        XCTAssertEqual(sut.cardPublicKeyProvider.clientKey, dummyClientKey)
        XCTAssertEqual(sut.environment.clientKey, dummyClientKey)
