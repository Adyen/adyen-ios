...
class VoucherViewTests: XCTestCase {
    ...
    func testModel() throws {
        ...
        let amountLabel: UILabel = try XCTUnwrap(sut.findView(by: "amountLabel"))
        let currencyLabel: UILabel = try XCTUnwrap(sut.findView(by: "currencyLabel"))
        let logo: NetworkImageView = try XCTUnwrap(sut.findView(by: "logo"))
