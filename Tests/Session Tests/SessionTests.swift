...
class SessionTests: XCTestCase {
    ...
    func testSessionAsDropInDelegate() throws {
        ...
        let actionComponent = PixComponent(context: context)
        ...
        dropIn.didOpenExternalApplication(component: PixComponent(context: context))
    ...
    func testResultCodeAuthorised() throws {
        ...
        sut.didProvide(actionData, from: PixComponent(context: context))
