...
class SEPADirectDebitComponentTests: XCTestCase {
    ...
    func testLocalizationWithCustomTableName() {
        ...
        XCTAssertEqual(sut.button.title, AmountAwarePaymentStringsPolicy.payButtonTitle(with: Dummy.amount, style: .immediate, sut.configuration.localizationParameters))
    }
    ...
    func testLocalizationWithZeroPayment() {
        ...
        XCTAssertEqual(sut.button.title, AmountAwarePaymentStringsPolicy.payButtonTitle(with: zeroAmount, style: .immediate, sut.configuration.localizationParameters))
